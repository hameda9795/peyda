...
async function main() {
    ...
    console.log(`Created/Updated business: ${business.name} (${business.id})`)
    ...
    console.log('\n✅ Test business seeded successfully!')
    console.log(`Business slug: de-koffie-kamer-utrecht`)
    console.log(`Owner email: owner@koffiekamer-utrecht.nl`)
}
