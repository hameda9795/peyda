        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 border border-slate-200">
                <div className="flex flex-col gap-3">
                    <div>
                        <h1 className="text-lg sm:text-2xl font-bold text-slate-800 mb-1">SEO Score Dashboard</h1>
                        <p className="text-sm text-slate-600">
                            Verbeter uw zichtbaarheid in Google
                        </p>
                    </div>
                    <button
                        onClick={handleRefresh}
                        disabled={refreshing}
                        className="flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 text-sm font-medium w-full"
                    >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                <div className="bg-white rounded-xl p-3 sm:p-4 border border-slate-200">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <Search className="w-6 h-6 sm:w-8 sm:h-8 text-blue-600 shrink-0" />
                ...
                <div className="bg-white rounded-xl p-3 sm:p-4 border border-slate-200">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-purple-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-white rounded-xl p-3 sm:p-4 border border-slate-200">
                    <div className="flex items-center gap-2 sm:gap-3">
                        <svg className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Priority Actions */}
            <div className={`${scoreData.bg} rounded-xl p-3 sm:p-6 border ${scoreData.border}`}>
                <h3 className="font-bold text-slate-800 mb-3 flex items-center gap-2 text-sm">
                    <TrendingUp className="w-4 h-4 shrink-0" />
                    <span className="flex-1">Snelle Wins</span>
